...
// 		}
	...
	function loadRealtimeStoreyChart () {
		var url = "http://47.93.123.129:8080/view/stays/"+ChosenGroupId+"/"+StartDate+"?unit=HOUR";
		//var url = "http://192.168.0.81:8080/view/stays/"+3+"/"+StartDate+"?unit=HOUR";
		$.ajax({
			url:url,
			dataType:"json",
	...
	function loadRealtimeCompareChart () {
		...
		//var url = "http://192.168.0.81:8080/view/stays/"+3+"/"+CompareDate+"?unit=HOUR";
		$.ajax({
			url:url,
			dataType:"json",
			success: realtimeChartCallback
	...
	function loadStoreyChart () {
		var url = basePath + "jaxrs/storey/indoor/nocompare/chart";
		var cxl = Math.random();
		var para = {
	...
	function loadStoreyStatistics () {
		var url = basePath + "jaxrs/storey/indoor/statistics";
		var cxl = Math.random();
		var para = {
				startDate : StartDate,endDate : EndDate,groupId : ChosenGroupId,cxl : cxl
		}
	...
	function loadStoreyCompareChart () {
		...
		$.post(url,para,loadStoreyCompareChartCallBack,"json");
	}
	function loadStoreyCompareChartCallBack (data) {
		var code = data.code; 
		if(code == 0){
			var dates = data.dates;
			var datas = data.datas;
		...
		<div class="maindiv">
			<div id="tab_bar_div">
				<ul class="tab_bar">
					...
					<li><a class="select" href="#">楼层经过顾客</a></li>
			...
			<div class="dataDiv">
				<div class="dataDiv_title">
					<div class="dataDiv_title_txt"><span id="title_storey">F1</span>经过顾客</div>
				</div>
