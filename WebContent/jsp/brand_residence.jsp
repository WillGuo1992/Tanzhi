...
// 		}
	...
	function loadResidenceBar () {
		var url = basePath + "jaxrs/brand/residence/nocompare/bar";
		var cxl = Math.random();
		var para = {
	...
	function loadResidenceChart () {
		var url = basePath + "jaxrs/brand/residence/nocompare/chart";
		var cxl = Math.random();
		var para = {
				startDate : StartDate,endDate : EndDate,groupId : ChosenGroupId,cxl : cxl
		}
	...
	function loadCompareResidenceBar () {
		var url = basePath + "jaxrs/brand/residence/compare/bar";
		var cxl = Math.random();
		var para = {
	...
	function loadCompareResidenceChart () {
		var url = basePath + "jaxrs/brand/residence/compare/chart";
		var cxl = Math.random();
		var para = {
				startDate : StartDate,endDate : EndDate,compareDate : CompareDate,groupId : ChosenGroupId,cxl : cxl
		}
		...
		<div class="maindiv">
			<div id="tab_bar_div">
				<ul class="tab_bar">
					...
					<li><a class="select" href="#">品牌停留时长</a></li>
				</ul>
			</div>
			<div id="top_tool_bar">
